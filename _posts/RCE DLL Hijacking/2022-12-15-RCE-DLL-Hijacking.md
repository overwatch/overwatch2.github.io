...
- RCE
- Product Security
description: Remote Code Execution via DLL Hijacking on a top 5 business automation product.
---
## DLL Hijacking
...
![Calc_payload](2.payload_gen.png "Calculator Payload")

## Placing Malicious DLL file in the application directory
![Placing_malicious_file](3.dll_location.png)
...
![reverseshell_payload](6.1.rce.png)
...
![proc_mon](6.2.rce.png)

### Windows reverse shell via meterpreter
![reverse_tcp_shell](6.3.rce.png)
